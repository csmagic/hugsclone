/* --------------------------------------------------------------------------
 * bignums.c:   Copyright (c) Mark P Jones 1991-1996.   All rights reserved.
...
static Bignum local bigNeg    Args((Bignum));
...
static Bignum local bigNeg(a)		/* unary negation		   */
Bignum a; {
    if (a==ZERONUM)
	return ZERONUM;
    else
...
primFun(primPlusInteger) {		/* Integer addition		   */
    eval(primArg(2));
    primArg(2) = whnfHead;
    eval(primArg(1));
    updateRoot(bigAdd(primArg(2),whnfHead));
    bn = NIL;
}
...
primFun(primMinusInteger) {		/* Integer subtraction		   */
    eval(primArg(2));
    primArg(2) = whnfHead;
    eval(primArg(1));
    updateRoot(bigSub(primArg(2),whnfHead));
    bn = NIL;
}
...
primFun(primMulInteger) {		/* Integer multiply		   */
    eval(primArg(2));
    primArg(2) = whnfHead;
    eval(primArg(1));
    updateRoot(bigMul(primArg(2),whnfHead));
    bn = NIL;
}
